package com.ismail.mynotesapp.provider
...
import com.ismail.mynotesapp.db.DatabaseContract.NoteColumns.Companion.AUTHORITY
...
class NoteProvider : ContentProvider() {
    ...
    init {
        // content://com.ismail.mynotesapp/note
        sUriMatcher.addURI(AUTHORITY, TABLE_NAME, NOTE)

        // content://com.ismail.mynotesapp/note/id
